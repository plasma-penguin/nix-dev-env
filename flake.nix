    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      let
        ...
        ubuntuContainerImage =
          if isLinux then
            let
              ubuntuImageDigest = "sha256:186072bba1b2f436cbb91ef2567abca677337cfc786c86e107d25b7072feef0c";
              ubuntuImageHashes = {
                "x86_64-linux" = "sha256-Wpf0yKdEWJIWrURX+uyLZnqjJ95IO99subetxl6krY0=";
                "aarch64-linux" = "sha256-sz53A8NbzCDqG8DOOuH2BpXuKDaJmifcn210HcK9zRM=";
              };
            in
            pkgs.dockerTools.buildImage {
